...
const config = {
  SESSION_ID: process.env.SESSION_ID || "Ethix-MD&Qe14Mv52",
  ...
  OWNER_NUMBER: process.env.OWNER_NUMBER || "2348123999085",
  SUDO_NUMBERS: process.env.SUDO_NUMBERS || "2348123999085,2348123999085",
